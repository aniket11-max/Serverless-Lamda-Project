...
The SNS topic then sends notifications (email/SMS) to all subscribed users.

4)This architecture showcases the event-driven serverless approach on AWS - scalable, cost-effective, and easy to maintain.
